...
function redButtonClicked() {
    ...
    color = "#EF476F"
    document.getElementById("q1-btn-red").onclick = setBackgroundColor(color);
}
...
function yellowButtonClicked() {
    // TODO: Use the setBackgroundColor() to set the background color to #EF476F (or another color of your choice)
    color = "#FFD166"
    document.getElementById("q1-btn-yellow").onclick = setBackgroundColor(color);
}
...
function greenButtonClicked() {
    color = "#06D6A0"
    document.getElementById("q1-btn-green").onclick = setBackgroundColor(color);
}
...
function lightblueButtonClicked() {
    color = "#118AB2"
    document.getElementById("q1-btn-lightblue").onclick = setBackgroundColor(color);
}
...
function blueButtonClicked() {
    color = "#073B4C"
    document.getElementById("q1-btn-blue").onclick = setBackgroundColor(color);
}
